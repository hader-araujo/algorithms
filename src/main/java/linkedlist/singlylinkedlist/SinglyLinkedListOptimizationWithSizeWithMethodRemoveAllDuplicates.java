...
public class SinglyLinkedListOptimizationWithSizeWithMethodRemoveAllDuplicates<T> {

    private int size;
    private Node<T> head;

    public SinglyLinkedListOptimizationWithSizeWithMethodRemoveAllDuplicates() {
        size = 0;
    }

    /*
    Remove duplicates in a Singly Single List where the data is already sorted
*/
