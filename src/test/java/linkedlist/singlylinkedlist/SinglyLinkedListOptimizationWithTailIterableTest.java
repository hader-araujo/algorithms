...
public class SinglyLinkedListOptimizationWithTailIterableTest {


    @Test
    public void testAddToFront() {
        SinglyLinkedListOptimizationWithTailIterable<Integer> sll = new SinglyLinkedListOptimizationWithTailIterable<>();
    ...
    public void testRemoveFront() {
        ...
        sll = new SinglyLinkedListOptimizationWithTailIterable<>();
        sll.removeFromFront();
